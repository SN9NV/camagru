...
if ($_POST['first'] && $_POST['last'] && $_POST['user'] && $_POST['passwd'] && $_POST['email']) {
    try {
        ...
        $message = '<html><head><title>Confirm your email address</title></head><body><h4>Please click the link below to verify your account on Camagru</h4><br /><a href="http://localhost:8080/#/confirm/'.$cyphertext_base64.'">Confirm email address</a></body></html>';
